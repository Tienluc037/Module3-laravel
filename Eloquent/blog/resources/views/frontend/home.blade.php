        ...
        <div class="header__top">
            <div class="header__logo">
                <a class="site-logo" href="index.html">
                    <img src="images/logo.svg" alt="Trang chủ">
                </a>
            </div>
        ...
        <nav class="header__nav-wrap">
            ...
            <ul class="header__nav">
                ...
                <li class="has-children">
                    <a href="#0" title="">Bài viết</a>
                    <ul class="sub-menu">
                        <li> <a class="collapse-item" href="{{route("posts.index")}}">Danh sách</a></li>
                        <li><a class="nav-link" href="{{route("posts.create")}}">Đăng bài</a></li>

                    </ul>
                </li>

                <li><a href="{{route('posts.showFavoriteList')}}" title="">Yêu thích</a></li>


                <li class="has-children">
                    <a href="#0" title="">Người dùng</a>
                    <ul class="sub-menu">
                        <li><a href="{{route("register.showFormRegister")}}">Đăng ký</a></li>
                    </ul>
                </li>
                <li><a href="{{ route('logout') }}" title="">Đăng xuất</a></li>
