        ...
        <div class="card-body">
            <form method="post" action="{{route('authors.update',$author->id)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nguyễn Văn A" value="{{ $author->name }}">
                    {{--                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">phone</label>
                    <input type="text" name="phone" class="form-control" id="exampleInputPassword1" placeholder="31356452" value="{{ $author->phone }}">
                </div>
